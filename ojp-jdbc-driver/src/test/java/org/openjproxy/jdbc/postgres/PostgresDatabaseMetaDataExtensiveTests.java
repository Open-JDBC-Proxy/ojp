...
public class PostgresDatabaseMetaDataExtensiveTests {
    ...
    void allDatabaseMetaDataMethodsShouldWorkAndBeAsserted(String driverClass, String url, String user, String password)
        ...
        try (ResultSet rs = meta.getBestRowIdentifier(null, null, "postgres_db_metadata_test",
        ...
        try (ResultSet rs = meta.getCrossReference(null, null, "postgres_db_metadata_test", null, null,
                "postgres_db_metadata_test")) {
            TestDBUtils.validateAllRows(rs);
        }
        ...
        // These tests has to be at the end as per when using hikariCP the connection
        // will be marked as broken after this operations.
