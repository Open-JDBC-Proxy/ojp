...
public class OracleMultipleTypesIntegrationTest {
    ...
    void typesCoverageTestSuccessful(String driverClass, String url, String user, String pwd)
        ...
        // Instant, OffsetDateTime, OffsetTime: NOT natively supported in Oracle JDBC
        // 4.2
        ...
        java.sql.PreparedStatement psSelect = conn
                .prepareStatement("select * from oracle_multi_types_test where val_int = ?");
        psSelect.setInt(1, 1);
        ...
        // Oracle natively supported java.time types - retrieve as Object to get the
        // actual type
     ...
     * - OffsetDateTime (can use TIMESTAMP WITH TIME ZONE but requires special
     * handling)
    ...
    void typesPartialSupportTest(String driverClass, String url, String user, String pwd) throws SQLException {
        ...
        // Test OffsetDateTime - Oracle has TIMESTAMP WITH TIME ZONE but JDBC 4.2
        // support varies
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/oracle_connections.csv")
    void testOracleSpecificTypes(String driverClass, String url, String user, String pwd)
        ...
        java.sql.PreparedStatement psSelect = conn
                .prepareStatement("SELECT nvarchar_col FROM test_oracle_types WHERE id = 1");
        ResultSet resultSet = psSelect.executeQuery();
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/oracle_connections.csv")
    void testOracleNumberTypes(String driverClass, String url, String user, String pwd)
            throws SQLException, ClassNotFoundException {
        assumeFalse(isTestDisabled, "Oracle tests are disabled");
    ...
    /**
     * Tests full roundtrip support for Oracle's native JSON column type (available
     * in Oracle 21c+).
     * <p>
     * Oracle 21c introduced a native binary JSON type ({@code JSON}) stored in OSON
     * format.
     * The Oracle JDBC driver may return vendor-specific objects from
     * {@code getObject()}; OJP
     * detects these by column type name and uses {@code getString()} to return
     * plain JSON text.
     * </p>
     * <p>
    ...
    void testOracleNativeJsonType(String driverClass, String url, String user, String pwd) throws SQLException {
        ...
        // so check for the presence of the expected keys and values rather than exact
        // equality.
