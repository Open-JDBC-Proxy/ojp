...
public class OracleDatabaseMetaDataExtensiveTests {
    ...
    void allDatabaseMetaDataMethodsShouldWorkAndBeAsserted(String driverClass, String url, String user, String password)
        ...
        try (ResultSet rs = meta.getBestRowIdentifier(null, null, "ORACLE_DB_METADATA_TEST",
        ...
        try (ResultSet rs = meta.getCrossReference(null, null, "ORACLE_DB_METADATA_TEST", null, null,
                "ORACLE_DB_METADATA_TEST")) {
            TestDBUtils.validateAllRows(rs);
        }
