...
public class SQLServerMultipleTypesIntegrationTest {
    ...
    void typesCoverageTestSuccessful(String driverClass, String url, String user, String pwd)
        ...
        // Instant, OffsetDateTime, OffsetTime: NOT natively supported in SQL Server
        // JDBC 4.2
        ...
        java.sql.PreparedStatement psSelect = conn
                .prepareStatement("select * from sqlserver_multi_types_test where val_int = ?");
        psSelect.setInt(1, 1);
    ...
    /**
     * Test SQL Server's behavior with java.time types that require special
     * handling.
     * SQL Server has DATETIMEOFFSET for timezone-aware types but JDBC 4.2 support
     * varies:
    ...
    void typesPartialSupportTest(String driverClass, String url, String user, String pwd) throws SQLException {
        ...
        try {
            ...
            // SQL Server JDBC drivers may throw various error messages for unsupported
            // types
        ...
        // Test OffsetDateTime - SQL Server has DATETIMEOFFSET but JDBC 4.2 support
        // varies
    ...
    @ParameterizedTest
    @ArgumentsSource(SQLServerConnectionProvider.class)
    void testSqlServerSpecificTypes(String driverClass, String url, String user, String pwd)
    ...
    @ParameterizedTest
    @ArgumentsSource(SQLServerConnectionProvider.class)
    void testSqlServerNullValues(String driverClass, String url, String user, String pwd)
            throws SQLException, ClassNotFoundException {
        assumeFalse(isTestDisabled, "SQL Server tests are disabled");
        ...
        java.sql.PreparedStatement psSelect = conn
                .prepareStatement("select * from sqlserver_null_test where val_int = ?");
        psSelect.setInt(1, 1);
        ResultSet resultSet = psSelect.executeQuery();
        resultSet.next();
    ...
    @ParameterizedTest
    @ArgumentsSource(SQLServerConnectionProvider.class)
    void testSqlServerLargeTypes(String driverClass, String url, String user, String pwd)
            throws SQLException, ClassNotFoundException {
        assumeFalse(isTestDisabled, "SQL Server tests are disabled");
        ...
        try {
            TestDBUtils.executeUpdate(conn,
                    "IF OBJECT_ID('sqlserver_large_types_test', 'U') IS NOT NULL DROP TABLE sqlserver_large_types_test");
        } catch (Exception e) {
            // Ignore
        }
    ...
    private void validateSQLServerJavaTimeTypes(ResultSet resultSet, LocalDateTime expectedLdt,
        ...
        // SQL Server natively supported java.time types - retrieve as Object to get the
        // actual type
