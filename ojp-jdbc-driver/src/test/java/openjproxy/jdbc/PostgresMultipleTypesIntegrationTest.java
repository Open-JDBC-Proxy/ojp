...
public class PostgresMultipleTypesIntegrationTest {
    ...
    public void typesCoverageTestSuccessful(String driverClass, String url, String user, String pwd, boolean isXA) throws SQLException, ClassNotFoundException, ParseException {
        ...
        try {
            System.out.println("Testing for url -> " + url + " (XA: " + isXA + ")");
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/postgres_connection.csv")
    public void testPostgresSpecificTypes(String driverClass, String url, String user, String pwd, boolean isXA) throws SQLException, ClassNotFoundException {
        assumeFalse(!isTestEnabled, "Postgres tests are disabled");
        ...
        try {
            System.out.println("Testing PostgreSQL-specific types for url -> " + url + " (XA: " + isXA + ")");
