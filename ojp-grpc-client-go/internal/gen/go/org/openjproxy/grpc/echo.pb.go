...
const file_echo_proto_rawDesc = "" +
	...
	"\vEchoService\x12K\n" +
	"\x04Echo\x12 .org.openjproxy.grpc.EchoRequest\x1a!.org.openjproxy.grpc.EchoResponseB\x14B\x10EchoServiceProtoP\x01b\x06proto3"
...
var file_echo_proto_goTypes = []any{
	(*EchoRequest)(nil),  // 0: org.openjproxy.grpc.EchoRequest
	(*EchoResponse)(nil), // 1: org.openjproxy.grpc.EchoResponse
}
var file_echo_proto_depIdxs = []int32{
	0, // 0: org.openjproxy.grpc.EchoService.Echo:input_type -> org.openjproxy.grpc.EchoRequest
	1, // 1: org.openjproxy.grpc.EchoService.Echo:output_type -> org.openjproxy.grpc.EchoResponse
